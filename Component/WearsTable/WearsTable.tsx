import {
  ...
  import {  getWears } from "../../requestApi";
  import ActionButtons from "../ActionButtons/ActionElectButtons";
 
import AddWears from "../AddWears/AddWears";
  import wear from "./Wears.module.css";
  ...
  const WearsTable = () => {
    const [wears, setWears] = useState<Array<string>>([]);
  ...
  console.log('resWears',response);
  
      setIsLoading(false);
      setWears(response?.data?.data);
    };
  ...
  useEffect(()=>{
      ...
      () => [
        ...
        },
        {
          ...
          Cell: (props) => {
            ...
            return (
              <Flex  flexWrap="wrap">
                { props?.cell?.row?.original?.sizes?.map((pro, idx) => (
    ...
    const data = useMemo(() => wears, [wears]);
        ...
        <Flex my="40px" w="100%" data-testid="roles">
          <Flex w="100%" flexDir="column">
            <Flex alignItems="center" justify="space-between" w="100%">
              ...
              <Box className={isOpen ? wear.ModalWears : ""}>
                {isOpen ? (
                  <AddWears isOpen={isOpen} handleIsOpen={handleIsOpen} handleReload={handleReload}/>
                ) : (
                  <Button
                    className={wear.BtnWears}
                    onClick={() => {
                      handleIsOpen(isOpen);
                    }}
                  >
