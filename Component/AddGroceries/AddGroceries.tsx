import {
  ...
  import { createElecroProduct, createGroceries, createKitProduct } from "../../requestApi";
  import FileBase from "react-file-base64";
  const AddGroceries = ({ isOpen, handleIsOpen, handleReload }) => {
    const [name, setName] = useState<string>("");
    const [groceId, setGroceId] = useState<string>("");
    ...
    const sendProduct = async (e) => {
      ...
      const response = await createGroceries({
        groceId,
        name,
        description,
        brand,
            ...
            <Box width="100%" ml="20px">
              <FormControl mt="20px">
                ...
                <Input
                  ...
                  mt="4px"
                  value={groceId}
                  onChange={(e) => setGroceId(e.target.value)}
                  fontSize="14px"
                />
              </FormControl>
