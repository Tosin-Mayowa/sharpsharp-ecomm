import {
  ...
  import { getKitProduct} from "../../requestApi";
  import ActionButtons from "../ActionButtons/ActionElectButtons";
import ActionKit from "../ActionButtons/ActionKit";
  import AddElectronics from "../AddElectronics/AddElectronics";
import AddKitchenPro from "../AddKitchenPro/AddKitchenPro";
  import styles from "./Kitmodal.module.css";
  ...
  const KitchenTable = () => {
    const [kitchen, setKitchen] = useState<Array<string>>([]);
  ...
  useEffect(()=>{
          ...
          Cell: (props) => {
            return (
              <Flex w="75%" justifyContent="flex-start">
                <ActionKit product={props?.cell?.row?.original} handleReload={handleReload}/>
              </Flex>
            );
          },
        },
    ...
    const data = useMemo(() => kitchen, [kitchen]);
        ...
        <Flex my="40px" w="100%" data-testid="roles">
          <Flex w="100%" flexDir="column">
            <Flex alignItems="center" justify="space-between" w="100%">
              ...
              <Box className={isOpen ? styles.ModalKit : ""}>
                {isOpen ? (
                  <AddKitchenPro isOpen={isOpen} handleIsOpen={handleIsOpen} handleReload={handleReload}/>
                ) : (
                  <Button
                    className={styles.BtnKit}
                    onClick={() => {
                      handleIsOpen(isOpen);
                    }}
                  >
